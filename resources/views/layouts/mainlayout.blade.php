...
<html lang="en">
    ...
    <body>
        ...
        <div data-bs-parallax-bg="true" style="height: 92%;background-image: url(https://picsum.photos/1280/720);background-position: center;background-size: cover;">
            <div class="ip-icon-bar"><a class="ip-active" href="/app"><i class="fa fa-home"></i></a><a href="#"><i class="fa fa-search"></i></a><a href="/app/matches/"><i class="fa fa-envelope"></i></a><a href="/app/profile"><i class="fa fa-globe"></i></a><a href="/logout"><i class="fa fa-trash"></i></a></div>
            @yield('content')
        </div>
        </div>
